...
import {AppMenusComponent} from '../app/menus.component/menus.component';
...
@NgModule({
  declarations: [
    AppComponent , AppMenusComponent ,
    WidgetsComponent , ArticleComponent , ArticleListComponent
  ],
  imports: [
  ...
  providers: [ArticleService , TimeNewsService , EarthQuakNewsService , TimesNewsTwitterService,
  BseSensexNewsService , ReadabilityScoreService,
  ReadabilityScoreSharedService],
